...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.armAngle = QtGui.QLCDNumber(self.gridLayoutWidget)
        ...
        self.speed = QtGui.QLCDNumber(self.gridLayoutWidget)
        ...
        self.eCode = QtGui.QLabel(self.gridLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.eCode.setFont(font)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.eCode.setText(_translate("MainWindow", "Place Holder", None))
